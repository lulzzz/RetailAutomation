...
public class DeviceConfig extends DeviceConfigPage{
	...
	public void protectionplan()  {
		try {
			...
			if(deviceprotection.equalsIgnoreCase("Xfinity Mobile Protection Plan (XMPP)"))
			{				
				clickElement(DeviceConfigPage.XMPP);
				log.info("Clicked XMPP Device Protection");
				
			}else if(deviceprotection.equalsIgnoreCase("No Xfinity Mobile Protection Plan (XMPP)"))
			{
