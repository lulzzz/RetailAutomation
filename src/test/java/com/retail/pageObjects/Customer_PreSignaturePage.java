...
public class Customer_PreSignaturePage extends WebOperations{
	...
	sameServiceAddress= By.xpath("/html/body/my-app/main/my-customer-pre-signature/div/div[2]/div[1]/my-address/div/div/div[2]/label/span"),
	firstName= By.xpath("/html/body/my-app/main/my-customer-pre-signature/div/div[2]/div[1]/my-address/div/form/div[1]/div[1]/my-input/label/input"),
	lastName= By.xpath("/html/body/my-app/main/my-customer-pre-signature/div/div[2]/div[1]/my-address/div/form/div[1]/div[2]/my-input/label/input"),
	address1= By.xpath("(//INPUT[@_ngcontent-c5=''])[3]"),
	address2= By.xpath("(//INPUT[@_ngcontent-c5=''])[4]"),
	city= By.xpath("(//INPUT[@_ngcontent-c5=''])[5]"),
	zipcode= By.xpath("(//INPUT[@_ngcontent-c5=''])[6]"),
	...
	state= By.xpath("/html/body/my-app/main/my-customer-pre-signature/div/div[2]/div[1]/my-address/div/form/div[5]/div[1]/my-select/div/button/span/span[1]"),
