...
@RTD-1551 @04/03
Scenario: Choose Payment plan through scan flow
...
@04/03 @RTD-1407
Scenario: Choose Payment plan through ship flow
	Given I lookup for a customer 
...
@RTD-1408 @04/03
Scenario: Choose Device protection Plan through scan flow
	Given I lookup for a customer 
	When I select a device with its customization through scan flow
 	Then I see the configuration details of the selected device
...
@04/03 @RTD-1552
Scenario: Choose Device protection Plan through ship flow
	Given I lookup for a customer 
	When I select a device with its customization through ship flow
 	Then I see the configuration details of the selected device
	When I choose to have device protection or not
...
@RTD-1409	@04/03
Scenario: Choose Data option through ship flow
	Given I lookup for a customer 
	When I select a device with its customization through scan flow
 	Then I see the configuration details of the selected device
...
@04/03
Scenario: Choose Data option through scan flow
	Given I lookup for a customer 
	When I select a device with its customization through ship flow
 	Then I see the configuration details of the selected device
	When I choose the data plan, By the Gig or Unlimited
...
@RTD-1424 @04/03
Scenario: Clicking on Next button through ship flow
    Given I lookup for a customer  
    When I select a device with its customization through ship flow
...
@04/03	@RTD-1549
Scenario: Clicking on Next button through scan flow
    Given I lookup for a customer  
    When I select a device with its customization through scan flow
    Then I select plans for payment,device protection and data
 	Then I see the configuration details of the selected device
	...
	Then I should be redirected to next page-Device_Customize
@RTD-1427	@04/03
Scenario: Clicking on Cancel button through scan flow
	Given I lookup for a customer  
    When I select a device with its customization through scan flow
    Then I select plans for payment,device protection and data
 	Then I see the configuration details of the selected device
  ...
  @04/03  @RTD-1550
 Scenario: Clicking on Cancel button through ship flow
	Given I lookup for a customer  
    When I select a device with its customization through ship flow
    Then I select plans for payment,device protection and data
 	Then I see the configuration details of the selected device
...
@RTD-1429 @04/03
Scenario: Clicking Learn more in protection plan through ship flow	
Given I lookup for a customer  
When I select a device with its customization through ship flow
Then I see the configuration details of the selected device
...
@04/03 @RTD-1547
Scenario: Clicking Learn more in protection plan through scan flow	
Given I lookup for a customer  
When I select a device with its customization through scan flow
Then I see the configuration details of the selected device
When I click on Learn more link
